...
{ 
    ...
    class SpriteBalon
    {
        ...
        //Constructor
        public SpriteBalon(int min_r, int max_r, int max_x, int max_y, int min_v, int max_v)
        {
            MaxX = max_x;
            MaxY = max_y;
        ...
        public void Move()
        {
            ...
            if (new_x < 0)
               ...
               if (new_x + Location.Width > MaxX)
                Velocity.X = -Velocity.X;
            if (new_y < 0)
                Velocity.Y = -Velocity.Y;
            else
                if (new_y + Location.Height > MaxY)
                Velocity.Y = -Velocity.Y;

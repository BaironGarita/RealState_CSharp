...
namespace Controles
{
    partial class frmAcercade : Form
    {
        public frmAcercade()
        {
            ...
            mensaje = "Los ejemplos que se incluyen en está aplicación ";
            mensaje += "son una guía sobre el manejo de  controles ";
            mensaje += "en el lenguaje C Sharp / C#, basado en la especificación de ";
            mensaje += "la Ecma 334 ";
            mensaje += "Para cualquier consulta ver http://www.ecma-international.org/";
            mensaje += "            ";
            mensaje += "Hecho por: \n";
            mensaje += "Anthony Morera Vasquez  \n";
            mensaje += "Sergio González Salazar \n" ;
